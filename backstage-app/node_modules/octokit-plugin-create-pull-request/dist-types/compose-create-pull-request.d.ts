...
export declare function composeCreatePullRequest(octokit: Octokit, { owner, repo, title, body, base, head, createWhenEmpty, changes: changesOption, draft, forceFork, }: Options): Promise<import("@octokit/types").OctokitResponse<{
    url: string;
    id: number;
    node_id: string;
    html_url: string;
