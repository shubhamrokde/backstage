...
var AsyncApiComponent = (function (_super) {
    ...
    AsyncApiComponent.prototype.render = function () {
        ...
        var concatenatedConfig = __assign(__assign(__assign({}, defaultConfig), config), { show: __assign(__assign({}, defaultConfig.show), (!!config && config.show)), sidebar: __assign(__assign({}, defaultConfig.sidebar), (!!config && config.sidebar)) });
        if (!asyncapi) {
            if (!error) {
                return null;
            }
