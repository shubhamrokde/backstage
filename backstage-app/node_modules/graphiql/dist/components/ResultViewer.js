...
var ResultViewer = (function (_super) {
    ...
    function ResultViewer() {
        ...
        _this.allAddons = function () { return [
            ...
            Promise.resolve().then(function () { return __importStar(require('codemirror/addon/search/search')); }),
            ...
            Promise.resolve().then(function () { return __importStar(require('codemirror-graphql/results/mode')); }),
        ]; };
        return _this;
    }
    ...
    ResultViewer.prototype.initializeEditor = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, importCodeMirror_1.importCodeMirror(this.allAddons(), {
                    ...
                    case 1:
                        ...
                        return [4, Promise.resolve().then(function () { return __importStar(require('codemirror-graphql/utils/info-addon')); })];
                    case 2:
                        _a.sent();
